...
const fullCityBytes = gzipSync(await readFile(`public/cities/vancouver/${baseline.fullCityData.artifact}`)).byteLength;
...
fail('Full city data', fullCityBytes, baseline.fullCityData.absoluteMaxGzipBytes);
...
console.log(`CSS ${cssBytes}; startup city data ${cityBytes}; optional full city data ${fullCityBytes}; default third-party ${thirdPartyBytes} gzip bytes.`);
